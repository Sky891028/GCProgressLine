...
-(void)viewDidLoad{
    ...
    _progressLine1.progressMaxValue = 999999; //设置最大值
    _progressLine1.progressValue = 877928;    //设置当前值
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        _progressLine2.progressValue = 3;
    });
    ...
    _progressLine3.progressValue = 20;    //设置当前值
